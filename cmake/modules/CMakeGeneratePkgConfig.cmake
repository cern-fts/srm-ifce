...
function(add_PkgConfigFile_for_Library)
	...
	LIST(APPEND pkgconfig_list_var ${pkgconfig_prefix} ${pkgconfig_libdir_var} 
								...
								${pkgconfig_version} ${pkgconfig_linkflags} ${pkgconfig_cflags})
