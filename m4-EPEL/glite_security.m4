...
[
    ...
    if test "x$GSOAP_VERSION_NUM" = "x020602" ; then
        gsoap_version_flavor="_262"
    elif test "x$GSOAP_VERSION_NUM" = "x020706" ; then
        gsoap_version_flavor="_276b"
    elif test "x$GSOAP_VERSION_NUM" = "x020710" ; then
        gsoap_version_flavor="_2710_c"
    elif test "x$GSOAP_VERSION_NUM" = "x020713" ; then
        gsoap_version_flavor="_2713_c"
    else
